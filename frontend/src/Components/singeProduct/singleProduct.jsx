...
const SingleProduct = () => {
      ...
      const updateFavorite = async () => {
         if (fav && foundFav) {
            ...
            try {
               ...
               const body = { user_id, favorites: product };
               await fetch(`${API_URL}fav/add`, {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify(body),
               });
   ...
   const handleCart = async () => {
      ...
      try {
         ...
         const body = { name: fullProduct.product.name };
         checkIfCartExist();
         const response = await fetch(`${API_URL}cart/check/${user.id}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(body),
         });
   ...
   useEffect(() => {
      const updateCart = async () => {
         if (cart && foundCart) {
            try {
               const body = { product };
               await fetch(`${API_URL}cart/update/addcart/${user.id}`, {
                  method: "PUT",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify(body.product),
               });
            ...
            try {
               const user_id = user.id;
               const body = { user_id, activeCart: product };
         ...
         <div className='singleproduct_wrapper'>
            <div className='singleproduct_wrapper_product'>
               ...
               <div className='singleproduct_wrapper_product_rightcol'>
                  ...
                  <div className='singleproduct_wrapper_product_rightcol_button'>
